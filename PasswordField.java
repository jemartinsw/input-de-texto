...
public class PasswordField extends JFrame //declaração da classe textfieldframe que está herdando o componente jframe.
{//Inicio do bloco da classe textfieldframe.
   ...
   public PasswordField()//Exportador do construtor para que ele possa ser importado (pública faz isso).
   {// inicio do bloco do construtor textfieldframe.
      super("PasswordField");//Super define o titulo da janela. Dever ser com aspas duplas.
   ...
   { // Início do bloco de códigos do método.
      PasswordField passwordField = new PasswordField();//Declraçaõ da variável PasswordField que está em camelcase que declara a variável. PasswordField é pascalcase que declara o tipo. Declara novo objeto e seu construtor PasswordField.
      passwordField.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);//Define operação de fechamento padrão. Invoca JFrame. e exit on close.
      passwordField.setSize(350, 100);//Define o tamanho como largura e altura.
      passwordField.setVisible(true);//Define a visibilidade.
